## MASTER SCRIPT FOR PRODUCING PLOT 2 ##
...
# produce line plot and send output to png file in current working directory
png(file = "plot2.png")
with(one_twoFeb07_dataframe, plot(Time, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)"))
dev.off()
# end of script
